...
if( FALSE ){
  devtools::install_local("C:/Users/James.Thorson/Desktop/Git/FishData" )
...
Species = "arrowtooth flounder"
 ...
 Sci_name = switch(Species, "arrowtooth flounder"="Atheresthes stomias" )
...
if( file.exists(paste0(DateFile,"Record.RData")) ){
  ...
  Surveys_to_include = c("WCGBTS", "Triennial", "BC", "GOA", "EBS", "AI")[c(1,3,4,5,6)] #This will only work for years after 2003
...
if( "WCGBTS" %in% Surveys_to_include ){
  ...
  Data1 = data.frame("Survey"="WCGBTS", "Region"="CC", "Lat"=WCGBTS[,'Lat'], "Lon"=WCGBTS[,'Long'], "Year"=WCGBTS[,'Year'], "Catch_KG"=WCGBTS[,'Wt'], "AreaSwept_km2"=0.01*WCGBTS[,'AreaSwept_ha'] )
